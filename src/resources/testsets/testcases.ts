...
export class Testcases extends APIResource {
  ...
  list(
    ...
    options?: RequestOptions,
  ): PagePromise<TestcaseListResponsesPaginatedResponse, TestcaseListResponse> {
...
export type TestcaseListResponsesPaginatedResponse = PaginatedResponse<TestcaseListResponse>;

export interface TestcaseCreateResponse {
  items: Array<TestcaseCreateResponse.Item>;
}

export namespace TestcaseCreateResponse {
  /**
  ...
  export interface Item {
     ...
     */
    validationErrors?: Array<Item.ValidationError>;
  }
...
export interface TestcaseListResponse {
   ...
   * fully conform to its testset's schema.
   */
  validationErrors?: Array<TestcaseListResponse.ValidationError>;
}

export namespace TestcaseListResponse {
  export interface ValidationError {
    /**
     * Human-readable error description
     */
