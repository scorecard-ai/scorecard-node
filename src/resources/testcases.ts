...
export class Testcases extends APIResource {
   ...
   */
  retrieve(testcaseID: number, options?: RequestOptions): APIPromise<TestcaseRetrieveResponse> {
  ...
  ): APIPromise<TestcaseUpdateResponse> {
...
export interface TestcaseRetrieveResponse {
   ...
   */
  validationErrors?: Array<TestcaseRetrieveResponse.ValidationError>;
}
...
export interface TestcaseUpdateResponse {
   ...
   * fully conform to its testset's schema.
   */
  validationErrors?: Array<TestcaseUpdateResponse.ValidationError>;
}

export namespace TestcaseUpdateResponse {
  export interface ValidationError {
    /**
     * Human-readable error description
     */
