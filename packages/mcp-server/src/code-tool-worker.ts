...
const fuse = new Fuse(
  [
    ...
    'client.metricGroups.create',
    'client.metricGroups.delete',
    'client.metricGroups.get',
    'client.metricGroups.list',
    'client.metricGroups.update',
    'client.records.create',
    'client.records.delete',
    'client.records.list',
    'client.records.annotations.list',
    'client.records.tags.create',
    'client.records.tags.delete',
    'client.records.tags.list',
    'client.records.assignees.create',
    'client.records.assignees.delete',
    'client.records.assignees.list',
    'client.scores.upsert',
    'client.attachments.commit',
    'client.attachments.delete',
    'client.attachments.get',
    'client.attachments.initiate',
