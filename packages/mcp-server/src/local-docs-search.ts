...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    "perLanguage": {
      "typescript": {
        ...
        "example": "import Scorecard from 'scorecard-ai';\n\nconst client = new Scorecard({\n  apiKey: process.env['SCORECARD_API_KEY'], // This is the default and can be omitted\n});\n\nconst project = await client.projects.create({\n  description: 'This is a test project',\n  name: 'My Project',\n});\n\nconsole.log(project.id);"
      },
      "python": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/projects \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\" \\\n    -d '{\n          \"description\": \"This is a test project\",\n          \"name\": \"My Project\"\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; description: string; fieldMapping: { expected: string[]; inputs: string[]; metadata: string[]; }; jsonSchema: object; name: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/projects/$PROJECT_ID/testsets \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/testsets/$TESTSET_ID \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; expected: object; inputs: object; jsonData: object; testsetId: string; validationErrors?: { message: string; path: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/testcases/$TESTCASE_ID \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/testsets/$TESTSET_ID/testcases \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ items: { id: string; expected: object; inputs: object; jsonData: object; testsetId: string; validationErrors?: object[]; }[]; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/testcases/bulk-delete \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\" \\\n    -d '{\n          \"ids\": [\n            \"123\",\n            \"124\",\n            \"125\"\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; metricIds: string[]; metricVersionIds: string[]; numExpectedRecords: number; numRecords: number; numScores: number; status: string; systemId: string; systemVersionId: string; testsetId: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/runs/$RUN_ID \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
    ...
    "httpMethod": "get",
    "summary": "List Runs",
    "description": "Retrieve a paginated list of all Runs for a Project. Runs are ordered by creation date, most recent first.",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/projects/$PROJECT_ID/runs \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/metrics/$METRIC_ID \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/projects/$PROJECT_ID/metrics \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; expected: object; inputs: object; outputs: object; runId: string; testcaseId?: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/runs/$RUN_ID/records \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\" \\\n    -d '{\n          \"expected\": {\n            \"idealAnswer\": \"bar\"\n          },\n          \"inputs\": {\n            \"question\": \"bar\"\n          },\n          \"outputs\": {\n            \"response\": \"bar\"\n          }\n        }'"
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/records/$RECORD_ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ data: { id: string; comment: string; createdAt: string; rating: boolean; recordId: string; spanId: string; userId: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/records/$RECORD_ID/annotations \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ metricConfigId: string; recordId: string; score: object; validationErrors?: { message: string; path: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/records/$RECORD_ID/scores/$METRIC_CONFIG_ID \\\n    -X PUT \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\" \\\n    -d '{\n          \"score\": {\n            \"value\": \"bar\",\n            \"reasoning\": \"bar\"\n          }\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; description: string; name: string; productionVersion: { id: string; config: object; name: string; systemId: string; }; versions: { id: string; name: string; }[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/projects/$PROJECT_ID/systems \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/systems/$SYSTEM_ID \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/systems/versions/$SYSTEM_VERSION_ID \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api2.scorecard.io/api/v2/systems/$SYSTEM_ID/versions \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $SCORECARD_API_KEY\" \\\n    -d '{\n          \"config\": {\n            \"temperature\": \"bar\",\n            \"maxTokens\": \"bar\",\n            \"model\": \"bar\"\n          }\n        }'"
      }
    }
  }
];
