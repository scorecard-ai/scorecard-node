...
if (metricIds.length > 0) {
  ...
  console.log('⚠️  No metrics configured. Add metric IDs to eval-params.json to enable automated scoring.');
}
...
console.log(`
  ...
  ${process.env.SCORECARD_APP_URL || 'https://app.scorecard.io'}/projects/${projectId}
